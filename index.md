...
Make sure to import pandas for this step and matplotlib (we will be using matplotlib later, but it is a good idea to do all imports at the top of your file).
```python
import pandas as pd
